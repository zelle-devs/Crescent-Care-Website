...
const ClientCarousel = ({ onClientClick }) => {
  const clients = [
    ...
    <section className="carousel-section">
      <div className="carousel-container">
        <motion.div
          ...
          transition={{ duration: 0.6, ease: "easeOut" }}
        >
          <span className="carousel-eyebrow">Registered Network</span>
              ...
              >
                ...
                >
                  {duplicatedRow.map((client, index) => (
                    ...
                    >
                      <div className="carousel-logo-plate">
                        <Image
                          src={client.logo}
                          alt={client.name}
                      ...
                      <span className="carousel-item-name">{client.name}</span>
                    </div>
                  ))}
                </motion.div>
              </motion.div>
