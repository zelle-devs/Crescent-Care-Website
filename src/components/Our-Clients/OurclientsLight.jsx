...
import "./OurClientsLight.css";
import Image from "next/image";
import ClientCarouselLight from "./ClientCarousel/ClientCarouselLight";
...
const OurClientsLight = () => {
  ...
  return (
    <>
      <ClientCarouselLight onClientClick={handleClientClick} />
      
      <section className="clients-section-light" id="clients-grid-section">
        <div className="clients-container-light">
          <motion.div
            className="clients-grid-light"
            ref={gridRef}
          ...
          >
            {clientsData.map((client) => (
              <motion.div
                className="client-card-light"
                key={client.id}
                id={`client-card-${client.id}`}
                variants={cardVariants}
              >
                <div className="client-logo-plate-light">
                  <Image
                    src={client.logo}
                    alt={client.name}
                ...
                <h3 className="client-name-light">{client.name}</h3>
                <p className="client-description-light">{client.description}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
...
export default OurClientsLight;